...
Sub papaya_extract()
    ...
    Dim genSel As IRobotSelection ' general object holder: bar or panel
    Dim selElem As IRobotResultParamType 'I_RPT_BAR or I_RPT_PANEL
    ...
    RobResQueryParams.ResultIds.Set 1, I_EVT_FORCE_BAR_FX ' IRobotExtremeValueType
